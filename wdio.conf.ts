...
console.log(`This headless flag: ${headless}`);
export const config: WebdriverIO.Config = {
  ...
  capabilities: [
    {
      ...
      maxInstances: 5,
      // "--disable-dev-shm-usage", "--no-sandbox" , "--window-size=1920,1080" "--disable-web-security",
      browserName: "chrome",
      "goog:chromeOptions": {
        args:
          headless === "Y"
  ...
  //
  // =====
  // Hooks // is a way we can control our execution it provides large of exhaustive Hooks
  // =====
  ...
  //   console.log(`TestId: ${JSON.stringify(world)}`);
